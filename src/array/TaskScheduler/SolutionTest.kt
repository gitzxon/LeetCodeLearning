...
class SolutionTest {
    ...
    @Test
    fun leastInterval() {
        val result = Solution().leastInterval(
                arrayOf("A","A","A","B","B","B").map { it[0] }.toCharArray(),
                2
        )
